...
const { updateTeamManagerSchema } = require('./src/schemas/teamManagerSchema');
...
const { schema: updateTeamManagerApiSchema } = createSchema(updateTeamManagerSchema);
  ...
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        UpdateTeamManager: updateTeamManagerApiSchema,
        Player: m2s(Player),
        Team: m2s(Team),
